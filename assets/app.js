...
【核心任务】负责完成全局埋点回收与节奏张弛的系统化设计，确保全书结构完整、情绪饱满。基于用户提供的小说书名、故事大纲、全部章节标题、万物词典，为每章标注本章节奏类型及原因，同时在全书层面完成埋点与回收规划。全书以轻松欢快喜剧为基调，每章必须设计让人不由自主发笑的逗趣事件与欢快剧情，并用具体的搞笑对话推动情节。
【硬性约束】
